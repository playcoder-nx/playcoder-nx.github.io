<template><div><h1 id="javascript-函数" tabindex="-1"><a class="header-anchor" href="#javascript-函数"><span>JavaScript 函数</span></a></h1>
<blockquote>
<p>在 JavaScript中，函数是头等 (first-class) 对象，因为它们可以像任何其他对象一样具有属性和方法。它们与其他对象的区别在于函数可以被调用。简而言之，它们是 Function 对象。(MDN)</p>
</blockquote>
<p>函数就是一段代码片段，调用函数就是执行函数中的代码。</p>
<h2 id="_1-函数的使用" tabindex="-1"><a class="header-anchor" href="#_1-函数的使用"><span>1. 函数的使用</span></a></h2>
<h3 id="_1-1-语法" tabindex="-1"><a class="header-anchor" href="#_1-1-语法"><span>1.1 语法</span></a></h3>
<p>函数使用前通常与变量一样需要先进行声明，用 <code v-pre>function</code> 关键字定义函数。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// 常见的函数的定义方式</span></span>
...
<li>调用函数就是执行函数中的代码</li>
<li>参数是调用函数的时候传递过去的，在函数执行过程中可以访问到</li>
<li>函数执行完毕后可以有一个返回值，调用函数的地方可以接收到这个返回值</li>
</ul>
<h3 id="_1-2-调用函数" tabindex="-1"><a class="header-anchor" href="#_1-2-调用函数"><span>1.2 调用函数</span></a></h3>
<blockquote>
<p>使用 <code v-pre>函数名()</code> 的方式即可调用一个函数</p>
</blockquote>
<p>以下是一个最简单的函数：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">say</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>调用这个函数就会在控制台输出 <code v-pre>hello</code> 字符串。</p>
<p><strong>这个函数没有返回值，默认会返回一个 <code v-pre>undefined</code></strong>。</p>
<h3 id="_1-3-带有参数与返回值的函数" tabindex="-1"><a class="header-anchor" href="#_1-3-带有参数与返回值的函数"><span>1.3 带有参数与返回值的函数</span></a></h3>
<blockquote>
<p>在声明函数的时候，可以对参数也做上说明</p>
</blockquote>
<p>假设有一个需求，<strong>需要一个计算三角形周长的函数</strong>。</p>
<p>计算三角形周长则需要知道三角形三条边各自的长度，然后将他们求和。</p>
<p>定义函数的时候就可以将三条边作为参数进行声明。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">calcPerimeter</span><span class="token punctuation">(</span><span class="token parameter">a<span class="token punctuation">,</span> b<span class="token punctuation">,</span> c</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line">代码块<span class="token number">123456789</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在调用函数的时可以传递值过去，这些值可以在函数中被访问。</p>
<p>在以上 <code v-pre>calcPerimeter</code> 函数被调用的时，传递了 <code v-pre>3, 4, 5</code> 三个值。</p>
<p>三个值对应到函数声明时定义的三个参数 <code v-pre>a, b, c</code>。</p>
<p>所以函数执行过程中 <code v-pre>sum</code> 的值为 <code v-pre>3 + 4 + 5</code>，即 <code v-pre>12</code>，随后 <code v-pre>sum</code> 被作为返回值进行返回。</p>
<p>最终变量 <code v-pre>perimeter</code> 也会被赋值为12。</p>
<h2 id="_2-怎么运用函数" tabindex="-1"><a class="header-anchor" href="#_2-怎么运用函数"><span>2. 怎么运用函数</span></a></h2>
<h3 id="_2-1-合理包装内容" tabindex="-1"><a class="header-anchor" href="#_2-1-合理包装内容"><span>2.1 合理包装内容</span></a></h3>
<p>函数可以对代码进行封装，让逻辑更加清晰。</p>
<p>比如如下代码块：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// 改写前</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上代码第一眼可能无法看出具体在做什么，仅需要做一点修改，就能有所改善。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// 改写后</span></span>
...
<p>通过 <code v-pre>isPrimeNumber</code> 函数名可以很容易的了解到这一段代码作用是用来判断一个数是否为<code v-pre>质数</code>。</p>
<p>当然有个前提就是起一个 <strong>可以让大部分人看得懂</strong> 的函数名。</p>
<h3 id="_2-2-优秀的函数名" tabindex="-1"><a class="header-anchor" href="#_2-2-优秀的函数名"><span>2.2 优秀的函数名</span></a></h3>
<p>优秀的函数名可以帮助他人更容易理解代码，同时当自己一段时间后再回头看代码时，能更容易进入当时写代码时候的思维模式等。</p>
<p>这里提供几个函数命名的建议，具体的命名可以根据团队规范、个人成长等做调整。</p>
<h4 id="_2-2-1-拼写准确" tabindex="-1"><a class="header-anchor" href="#_2-2-1-拼写准确"><span>2.2.1 拼写准确</span></a></h4>
<p>准确的拼写十分重要，绝大多数情况下函数名都会是英文单词组成的。</p>
<p>当然许多时候手一快可能就少了一个字母，或者错将 <code v-pre>wrap</code> 进行乾坤大挪移拼写成了 <code v-pre>warp</code>。</p>
<p>许多情况是无法避免的，经常需要自检。</p>
<p>当然可以借助一些单词的检查插件，如 <code v-pre>Visual Studio Code</code> 可以借助 <code v-pre>Code Spell Checker</code> 插件来检查单词的正确性。</p>
<p>再者碰到想起的函数名但是单词拼写不出来，尽可能翻词典，日积月累能有大量的词汇沉淀。</p>
<h4 id="_2-2-2-尽量不使用拼音或者混用拼写" tabindex="-1"><a class="header-anchor" href="#_2-2-2-尽量不使用拼音或者混用拼写"><span>2.2.2 尽量不使用拼音或者混用拼写</span></a></h4>
<p>尽量不要使用拼音或者是首字母缩写。</p>
<p>以下函数名或许会造成困扰：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">jslsh</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上是<code v-pre>计算两数和</code>函数的命名，可能只有天和地知道这个是什么意思。</p>
<p>当然，如果是自己写 demo 或者测试代码的时候，其实不需要考虑这么多。</p>
<h4 id="_2-2-3-有-状态-的函数名" tabindex="-1"><a class="header-anchor" href="#_2-2-3-有-状态-的函数名"><span>2.2.3 有“状态”的函数名</span></a></h4>
<p>如碰到函数功能是判断<code v-pre>是否</code>、<code v-pre>有没有</code>、<code v-pre>可以</code>的时候，可以带上一些前缀，比如：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// 是否登入</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>同时可以合理的使用动词，比如<code v-pre>打开文件</code>就可以使用 <code v-pre>openFile</code> 函数名，具体的状态可以根据语境、函数作用、个人习惯等做调整使用。</p>
<h4 id="_2-2-4-合理使用缩写" tabindex="-1"><a class="header-anchor" href="#_2-2-4-合理使用缩写"><span>2.2.4 合理使用缩写</span></a></h4>
<p>使用词语的缩写尽量使用通用的缩写</p>
<p>如：</p>
<ul>
<li>pwd - password</li>
<li>mgr - manager</li>
...
<p>这些缩写大部分开发者是可以看的懂的缩写。</p>
<h2 id="_3-函数示例" tabindex="-1"><a class="header-anchor" href="#_3-函数示例"><span>3. 函数示例</span></a></h2>
<h3 id="_3-1-计算圆的面积" tabindex="-1"><a class="header-anchor" href="#_3-1-计算圆的面积"><span>3.1 计算圆的面积</span></a></h3>
<p>分析：根据圆面积公式 S=π·r·r，其中 S 就是要求的值，即函数的返回值，π 是常量(固定的一个值)，半径r是未知数，所以r就可以设计成参数</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">circleArea</span><span class="token punctuation">(</span><span class="token parameter">r</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-判断某个dom元素是否含有某个类名" tabindex="-1"><a class="header-anchor" href="#_3-2-判断某个dom元素是否含有某个类名"><span>3.2 判断某个DOM元素是否含有某个类名</span></a></h3>
<p>分析：</p>
<p><code v-pre>某个DOM</code>和<code v-pre>某个类名</code>可以说明有两个未知量，可以设计成两个参数。</p>
<p>根据描述也可以确定一个 <code v-pre>某个DOM</code> 的类型是个 <code v-pre>DOM</code> 对象，<code v-pre>某个类名</code>是个字符串</p>
<p>只要拿到这个DOM的 <code v-pre>class</code> 属性，判断里面是不是含有这个类型即可得到结果</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">hasClass</span><span class="token punctuation">(</span><span class="token parameter">el<span class="token punctuation">,</span> className</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-函数的其他知识" tabindex="-1"><a class="header-anchor" href="#_4-函数的其他知识"><span>4. 函数的其他知识</span></a></h2>
<blockquote>
<p>以下扩展内容可能需要一定的知识积累，遇到不懂的地方可以停下脚步，先学习下一章节</p>
</blockquote>
<h3 id="_4-1-函数表达式" tabindex="-1"><a class="header-anchor" href="#_4-1-函数表达式"><span>4.1 函数表达式</span></a></h3>
<p>以上篇幅的函数其实都通过<code v-pre>函数声明</code>的方式来定义，还有一种方式就是使用函数表达式定义函数。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// 函数声明</span></span>
...
<span class="line">代码块<span class="token number">123456789</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过上述例子可以看出写法上的区别就是<code v-pre>函数表达式</code>是将函数赋值给了变量。</p>
<p>这两种方式创建的函数最大的区别在于，<strong>不能提前调用使用函数表达式创建的函数</strong></p>
<p>光看句子有点抽象，举个例子?：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">var</span> num1 <span class="token operator">=</span> <span class="token function">add1</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面一段代码在执行的时候会报 <code v-pre>add2 is not a function</code> 的错误，表示 <code v-pre>add2</code> 不是函数，也就是说 <code v-pre>add2</code> 不能被提前使用，而 <code v-pre>add1</code> 可以。</p>
<p>具体原因可以查看<code v-pre>执行上下文</code>章节。</p>
<h3 id="_4-2-函数作用域" tabindex="-1"><a class="header-anchor" href="#_4-2-函数作用域"><span>4.2 函数作用域</span></a></h3>
<p>函数有他自己的作用域，函数内声明的变量等<code v-pre>通常情况下</code>不能被外部访问，但是函数可以访问到外部的变量或者其他函数等</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>执行以上代码会报 <code v-pre>b is not defined</code> 错误。</p>
<h3 id="_4-3-匿名函数" tabindex="-1"><a class="header-anchor" href="#_4-3-匿名函数"><span>4.3 匿名函数</span></a></h3>
<p>没有名字的函数就是一个匿名函数</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">var</span> <span class="token function-variable function">fn</span> <span class="token operator">=</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line">代码块<span class="token number">123</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>除了在<code v-pre>函数表达式</code>中会出现匿名函数，还有许多场景。</p>
<p>相对常见的一个就是<code v-pre>自执行匿名函数</code>，MDN官方翻译为<code v-pre>立即调用函数表达式</code>。</p>
<p><code v-pre>自执行</code>就是这个函数声明后就会立即执行，自执行的匿名函数通常会被用来<code v-pre>形成独立的作用域</code>。</p>
<p>如：</p>
...
<span class="line">代码块<span class="token number">12345</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这是一个自执行的匿名函数，这个匿名函数是被包裹了一段括号后才被调用的。</p>
<p>以下这段代码会报错：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// 报错</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>浏览器会告诉你必须给函数一个名字。</p>
<p>通过括号包裹一段函数，让<code v-pre>js引擎</code>识别成他是一个函数表达式，再对他进行执行，就不会报错，这是加括号的原因。</p>
<p>同理，可以使用 <code v-pre>+</code>，<code v-pre>!</code> 等运算符代替括号，让一个匿名函数成为一个函数表达式即可。</p>
<p>大部分第三方框架都会通过一个自执行的匿名函数包裹代码，与浏览器全局环境隔离，避免污染到全局环境。</p>
<h3 id="_4-4-具有函数名的函数表达式" tabindex="-1"><a class="header-anchor" href="#_4-4-具有函数名的函数表达式"><span>4.4 具有函数名的函数表达式</span></a></h3>
<p>函数表达式进行声明的时候也可以使用具名函数</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">var</span> <span class="token function-variable function">count</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token function">fn</span><span class="token punctuation">(</span><span class="token parameter">num</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line">代码块<span class="token number">123</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上这段代码是不会报错的，但是不能通过 <code v-pre>fn</code> 访问到函数，这里的 <code v-pre>fn</code> 只能在函数内部进行访问，通常在使用递归的形式做计算的时候会用到这种写法。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">var</span> <span class="token function-variable function">count</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token function">fn</span><span class="token punctuation">(</span><span class="token parameter">num</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line">代码块<span class="token number">123456789</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面这个例子，就是在函数内部访问 <code v-pre>fn</code> 调用自己，使用递归的形式求和。</p>
<p><strong>注：递归相关的知识可以参考相关文献进行学习</strong></p>
<h3 id="_4-5-arguments" tabindex="-1"><a class="header-anchor" href="#_4-5-arguments"><span>4.5 arguments</span></a></h3>
<blockquote>
<p>arguments 是一个对应于传递给函数的参数的类数组对象。(MDN)</p>
</blockquote>
<p>通常情况下函数都具有 <code v-pre>arguments</code> 对象，可以在函数内部直接访问到。</p>
<p>他是一个类数组，即长得很像数组，成员都是用数字编号，同时具有 length 属性。</p>
<p>arguments 中存放着当前函数被调用时，传递过来的所有参数，即便不声明参数，也可以通过 arguments 取到传递过来的参数。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">sum</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line">代码块<span class="token number">12345</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>执行上述代码，可以看到在控制台输出了一个对象，存放的就是所有传递过去的参数，利用这一特性，就可以不限制参数个数，或者让函数做中转站（拦截函数），利用 arguments 将参数传递给另一个函数。</p>
<p>如，一个不确定用户输入的参数个数的求和函数：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">sum</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过循环遍历 <code v-pre>arguments</code> 对象，就可以得到所有参数，然后做累加就可以达到求和的目的。</p>
<h3 id="_4-6-函数和方法" tabindex="-1"><a class="header-anchor" href="#_4-6-函数和方法"><span>4.6 函数和方法</span></a></h3>
<p>方法在本质上是个函数。</p>
<p>通常都能听到“调用一下某个方法”，“取到某个方法的返回值”，这里的方法其实就是一个函数。</p>
<p>一般方法是用来描述对象的某个行为的，但是平时我们会混用，口头交流的时候会经常把函数直接称作方法。</p>
<p>只要自己理解，不需要去纠结函数和方法到底是什么，也不用特意纠正别人的说法，大家都能听得懂就行。</p>
<h3 id="_4-7-js-doc-注释" tabindex="-1"><a class="header-anchor" href="#_4-7-js-doc-注释"><span>4.7 JS DOC 注释</span></a></h3>
<p>使用 <code v-pre>JS DOC</code> 描述函数是非常良好的习惯，良好的 <code v-pre>JS DOC</code> 书写还可以使用工具快速生成文档。</p>
<p><code v-pre>JS DOC</code> 对函数的描述大体如下：</p>
...
<span class="line">代码块<span class="token number">12345678</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>除此之外还可以描述返回值等。</p>
<h3 id="_4-8-纯函数与副作用" tabindex="-1"><a class="header-anchor" href="#_4-8-纯函数与副作用"><span>4.8 纯函数与副作用</span></a></h3>
<p>所谓纯函数，就是没有副作用的函数</p>
<p>一个函数从执行开始到结束，没有对外部环境做任何操作，即对外部环境没有任何影响（没有副作用），这样的函数就是纯函数。</p>
<p>纯函数只负责输入输出，对于一种输入只有一种函数返回值。</p>
<p>如果函数中存在 <code v-pre>Math.random</code> 这种影响返回值的函数，也不能算是纯函数。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// 纯函数</span></span>
<span class="line"><span class="token keyword">function</span> <span class="token function">add</span><span class="token punctuation">(</span><span class="token parameter">a<span class="token punctuation">,</span> b</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
<span class="line">  <span class="token keyword">return</span> a <span class="token operator">+</span> b<span class="token punctuation">;</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-9-构造函数" tabindex="-1"><a class="header-anchor" href="#_4-9-构造函数"><span>4.9 构造函数</span></a></h3>
<p>当一个函数与 <code v-pre>new</code> 关键字一起被调用的时候，就会作为一个构造函数。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">Person</span><span class="token punctuation">(</span><span class="token parameter">name<span class="token punctuation">,</span> age</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line">代码块<span class="token number">1234567891011121314</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看到当函数作为构造函数调用的时候，默认返回的是一个对象。</p>
<p>细心的读者仔细观察就能发现，构造函数的默认返回值是函数体内的 this。</p>
<p>事实上构造函数的执行有一定流程：</p>
<ol>
<li>创建一个空对象，将函数的this指向这个空对象</li>
<li>执行函数</li>
<li>如果函数没有指定返回值，则直接返回 this（一开始创建的空对象），否则返回指定返回值</li>
</ol>
<p>理解这个流程，就能理解构造函数的返回值。</p>
<p>具体的函数的 <code v-pre>prototype</code> 属性等可以参阅<code v-pre>原型</code>章节。</p>
<h2 id="_5-小结" tabindex="-1"><a class="header-anchor" href="#_5-小结"><span>5. 小结</span></a></h2>
<p>函数特性相对较多，也是 JavaScript 的核心之一。</p>
<p>函数可以用于封装代码，提供代码的复用率和可读性，在大部分情况下，当两段代码具有超高相似度时，应当设计成函数，不同的部分使用参数进行区分。</p>
</div></template>
