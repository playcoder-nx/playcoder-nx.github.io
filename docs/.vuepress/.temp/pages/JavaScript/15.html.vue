<template><div><h1 id="javascript-数组" tabindex="-1"><a class="header-anchor" href="#javascript-数组"><span>JavaScript 数组</span></a></h1>
<blockquote>
<p>数组是一种使用整数作为键 (integer-key-ed) 属性和长度 (length) 属性之间关联的常规对象。此外，数组对象还继承了 Array.prototype 的一些操作数组的便捷方法。——MDN</p>
</blockquote>
<p>数组可以存放多个值。数组的<code v-pre>数</code>不是指数字，而是指<code v-pre>数据</code>，数组可以存放任意数据类型的值。</p>
<p>从理论上讲，在内存允许的情况下，数组的长度是无限的。</p>
<p><img src="https://img.mukewang.com/wiki/5e7ae0cd095da6a214400768.jpg" alt="图片描述"></p>
<h2 id="_1-创建数组" tabindex="-1"><a class="header-anchor" href="#_1-创建数组"><span>1. 创建数组</span></a></h2>
<p>数组由中括号 <code v-pre>[]</code> 包裹，每一项之间用逗号 <code v-pre>,</code> 分隔。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token punctuation">[</span>第一项<span class="token punctuation">,</span> 第二项<span class="token punctuation">,</span> 第三项<span class="token punctuation">,</span> <span class="token operator">...</span> <span class="token punctuation">,</span> 第n项<span class="token punctuation">]</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>创建数组最常见的方式是使用字面量。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">var</span> hobby <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token string">'java'</span><span class="token punctuation">,</span> <span class="token string">'c'</span><span class="token punctuation">,</span> <span class="token string">'c++'</span><span class="token punctuation">,</span> <span class="token string">'python'</span><span class="token punctuation">,</span> <span class="token string">'javascript'</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token boolean">true</span><span class="token punctuation">,</span> <span class="token boolean">false</span><span class="token punctuation">]</span><span class="token punctuation">;</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过直接描述一个数组的方式就可以创建一个数组。</p>
<h2 id="_2-数组长度" tabindex="-1"><a class="header-anchor" href="#_2-数组长度"><span>2. 数组长度</span></a></h2>
<p>数组的长度可以通过 <code v-pre>length</code> 属性获取。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">var</span> arr <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">4</span><span class="token punctuation">,</span> <span class="token number">5</span><span class="token punctuation">]</span><span class="token punctuation">;</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-访问数组成员" tabindex="-1"><a class="header-anchor" href="#_3-访问数组成员"><span>3. 访问数组成员</span></a></h2>
<p>数组的每一项可以称之为<code v-pre>成员</code>。</p>
<p>数组成员可以通过<code v-pre>下标</code>访问，下标也可以称为<code v-pre>索引</code>。</p>
<p>下标可以理解成数组成员的编号，编号从 0 开始，到数组长度 -1 。</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过<code v-pre>数组[下标]</code> 的方式即可访问到成员。</p>
<h2 id="_4-遍历数组" tabindex="-1"><a class="header-anchor" href="#_4-遍历数组"><span>4. 遍历数组</span></a></h2>
<p>数组遍历主要有两种方式：</p>
<ul>
<li>for 循环</li>
<li>forEach 方法</li>
</ul>
<h3 id="_4-1-for-循环" tabindex="-1"><a class="header-anchor" href="#_4-1-for-循环"><span>4.1 for 循环</span></a></h3>
<p>使用 for 循环，从数组下标 0 循环到最后一位，过程中通过下标访问成员。</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-2-foreach-方法" tabindex="-1"><a class="header-anchor" href="#_4-2-foreach-方法"><span>4.2 forEach 方法</span></a></h3>
<p><code v-pre>forEach</code> 是数组原型上的方法，所有数组都具有此方法。</p>
<p>forEach 接收一个函数作为参数，在遍历每一项的时候，这个函数会被调用，同时将当前遍历到的项、当前项的下标（索引)、遍历的数组作为函数参数传递过来。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">var</span> arr <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token string">'第一项'</span><span class="token punctuation">,</span> <span class="token string">'第二项'</span><span class="token punctuation">,</span> <span class="token string">'第三项'</span><span class="token punctuation">,</span> <span class="token string">'第四项'</span><span class="token punctuation">,</span> <span class="token string">'第五项'</span><span class="token punctuation">]</span><span class="token punctuation">;</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>第二个参数的值也是从 0 开始的。</p>
<p>通常第三个参数用到的比较少，没有用到可以没必要接收这个参数。</p>
<h2 id="_5-修改数组成员的值" tabindex="-1"><a class="header-anchor" href="#_5-修改数组成员的值"><span>5. 修改数组成员的值</span></a></h2>
<p>成员的值可以通过<code v-pre>数组[下标] = 值</code>的方式进行修改。</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-增减数组项" tabindex="-1"><a class="header-anchor" href="#_6-增减数组项"><span>6. 增减数组项</span></a></h2>
<p>数组提供了很多方式来对成员进行增减操作，也可以依靠其他特性来增加减少数组成员。</p>
<h3 id="_6-1-增加" tabindex="-1"><a class="header-anchor" href="#_6-1-增加"><span>6.1 增加</span></a></h3>
<h4 id="_6-1-1-直接给指定位置赋值" tabindex="-1"><a class="header-anchor" href="#_6-1-1-直接给指定位置赋值"><span>6.1.1 直接给指定位置赋值</span></a></h4>
<p>通过下标，直接访问到一个不存在的成员，然后进行赋值，就可以为数组增加一项。</p>
...
<span class="line">代码块<span class="token number">1234567</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_6-1-2-push-方法" tabindex="-1"><a class="header-anchor" href="#_6-1-2-push-方法"><span>6.1.2 push 方法</span></a></h4>
<p>push 方法接收任意个参数，这些参数会依次添加到数组的末尾，添加完后返回数组新的长度。</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通常不会用到这个返回的长度，可以不需要接收返回值。</p>
<h4 id="_6-1-3-unshift-方法" tabindex="-1"><a class="header-anchor" href="#_6-1-3-unshift-方法"><span>6.1.3 unshift 方法</span></a></h4>
<p>unshift 接收任意个参数，这些参数会被添加到数组头部，添加完后返回数组新的长度。</p>
...
<span class="line">代码块<span class="token number">123456</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-2-删除" tabindex="-1"><a class="header-anchor" href="#_6-2-删除"><span>6.2 删除</span></a></h3>
<h4 id="_6-2-1-pop-方法" tabindex="-1"><a class="header-anchor" href="#_6-2-1-pop-方法"><span>6.2.1 pop 方法</span></a></h4>
<p>pop 方法会删除数组最后一项，并将删除项作为返回值。</p>
...
<span class="line">代码块<span class="token number">12345</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果数组是空的，调用 pop 会返回 <code v-pre>undefined</code> 。</p>
<h4 id="_6-2-2-shift-方法" tabindex="-1"><a class="header-anchor" href="#_6-2-2-shift-方法"><span>6.2.2 shift 方法</span></a></h4>
<p>shift 方法会删除数组的第一项，并将删除项作为返回值。</p>
...
<span class="line">代码块<span class="token number">12345</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>与 pop 一样，如果是数组为空的情况下，会返回 <code v-pre>undefined</code> 。</p>
<h3 id="_6-3-在数组中间删除或添加值" tabindex="-1"><a class="header-anchor" href="#_6-3-在数组中间删除或添加值"><span>6.3 在数组中间删除或添加值</span></a></h3>
<p>splice 方法可以在任意位置添加或删除值。</p>
<p>这个方法接受任意个参数，前两个为从哪里开始（从 0 开始计数），删除几个，从第三个开始则是要添加的项。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line">arr<span class="token punctuation">.</span><span class="token function">splice</span><span class="token punctuation">(</span>从第几个开始<span class="token punctuation">,</span> 要删除几个<span class="token punctuation">,</span> 要添加的项目<span class="token number">1</span><span class="token punctuation">,</span> 要添加的项目<span class="token number">2</span><span class="token punctuation">,</span> <span class="token operator">...</span><span class="token punctuation">,</span> 要添加的项目n<span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line">代码块<span class="token number">1</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><p>如果不需要删除，只需要往数组中间插入值，只需要传递 0 给第二个参数即可。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// 在第二项之后插入3, 4, 5</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>因为第一个参数是从 0 开始计数，所以在第二项之后，就是要插入在第三项的位置，所以传递 2 ，不需要删除项目，所以第二个参数传递 0 ，之后就是要插入的项。</p>
<blockquote>
<p>注意：往数组中间插入数据的情况相对较少，数组做这种操作是比较低效的，小量的操作对性能的影响可以忽略不计，但有超大量非首尾的增减操作，应考虑使用<code v-pre>链表</code>。</p>
</blockquote>
<p>删除项只需要指定从第几项开始删除，要删除几项即可。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// 去除 '996'、'加班'</span></span>
...
<span class="line">代码块<span class="token number">1234</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>'996’和’加班’是连续的，所以一个 splice 就可以删除掉这 2 项，2 个参数的意思就是从第 2 项开始，删除 2 项。</p>
<h2 id="_7-清空数组" tabindex="-1"><a class="header-anchor" href="#_7-清空数组"><span>7. 清空数组</span></a></h2>
<p>将数组所有成员全部删除就达到了清空的效果。</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当然也可以使用 <code v-pre>pop</code> 一个个删除，但是通常都不会用这种方式。</p>
<p>清空数组最常用的方式是重新给变量赋值。</p>
...
<span class="line">代码块<span class="token number">12345</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过给变量赋值一个新的空数组，达到清空数组的目的，但是这样会改变引用，新赋值的数组和之前的数组并不是同一个。</p>
<p>另一种方式可以让保持对当前数组的引用。</p>
...
<span class="line">代码块<span class="token number">123</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过给数组的 <code v-pre>length</code> 属性重新赋值，也可以达到清空数组的效果。</p>
<p>这种方式相对灵活，假如需求是保留三项、五项，只需要给 length 赋值对应的值即可。</p>
<h2 id="_8-使用-array-创建数组" tabindex="-1"><a class="header-anchor" href="#_8-使用-array-创建数组"><span>8. 使用 Array 创建数组</span></a></h2>
<p>内建对象 <code v-pre>Array</code> 也可以用来创建数组。</p>
...
<span class="line">代码块<span class="token number">1</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><p>如果什么参数都不传递，则返回一个空数组。</p>
<p>传参则有 2 种情况：</p>
<ul>
<li>如果只传一个参数，并且这个参数的类型为数字，则会创建长度为这个数字的数组；</li>
<li>传入其他类型的一个或者多个参数，则会将这些参数组合成数组。</li>
</ul>
...
<span class="line">代码块<span class="token number">1234</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在控制台可以观察到这个数组长度为 10，但均为 <code v-pre>empty</code> 。</p>
<p>如果尝试着访问其中某一项，得到的值是 <code v-pre>undefined</code> 。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">var</span> arr1 <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Array</span><span class="token punctuation">(</span><span class="token string">'item1'</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line"></span>
...
<span class="line">代码块<span class="token number">123456</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样创建的数组，成员与传参一致。</p>
<h2 id="_9-数组中的-undefined-与-empty" tabindex="-1"><a class="header-anchor" href="#_9-数组中的-undefined-与-empty"><span>9. 数组中的 undefined 与 empty</span></a></h2>
<p>在数组中 undefined 与 empty 是有区别的。</p>
<p>使数组项变成 <code v-pre>empty</code> 通常有两种方式。</p>
<ul>
<li>使用 Array 对象同时提供了长度创建出来的数组</li>
<li>使用 <code v-pre>delete</code> 关键字删除的数组项</li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">var</span> arr1 <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Array</span><span class="token punctuation">(</span><span class="token number">10</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line"></span>
...
<p>虽然 empty 的项在访问的时候返回的是 undefined ，但其本身只做简单占位，\ 是遍历不到的。</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面两种遍历的方式都是遍历不到 <code v-pre>empty</code> 项的，而 <code v-pre>undefined</code> 是可以遍历到的，这是最主要的区别。</p>
<h2 id="_10-使用数组" tabindex="-1"><a class="header-anchor" href="#_10-使用数组"><span>10. 使用数组</span></a></h2>
<p>数组非常常用，大量的 HTML 字符串在做拼接的时候，就会使用到数组。</p>
<p>除了用于简单的存储数据，数组也可以被用来解决问题。</p>
<h3 id="_10-1-判断括号是否匹配" tabindex="-1"><a class="header-anchor" href="#_10-1-判断括号是否匹配"><span>10.1 判断括号是否匹配</span></a></h3>
<p>判断一个数学式子的括号匹配是否合法，如 <code v-pre>(1 + 2) * (3 + 4))</code> ，这个式子就是不合法的。</p>
<p>校验括号合法不单单要看左括号和右括号的数量是否相等，还要看括号的顺序， <code v-pre>))((</code> 这样的括号顺序一定是错误的。</p>
<p>利用 JavaScript 数组的特性，可以很容易的实现。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// 空数组</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用数组实现的具体思路就是，碰到左括号就往数组里放一个成员，碰到一个右括号就拿掉一个成员。</p>
<p>这样如果最后有剩下，说明括号没有一一成对。</p>
<p><code v-pre>(1+2*(3+4))*1</code> 如这样一个式子：</p>
<div class="language-txt line-numbers-mode" data-highlighter="prismjs" data-ext="txt"><pre v-pre><code><span class="line">初始化操作：</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当然这种判断有局限性，假如碰到 <code v-pre>((1+)2)-3</code> 这种非括号造成不合法的式子，就判断不出来了。</p>
<blockquote>
<p>其实这里用到了<code v-pre>栈</code>这种数据结构，这个问题在栈的应用上很经典，是算法入门常见面试题之一。</p>
</blockquote>
<h2 id="_11-类数组" tabindex="-1"><a class="header-anchor" href="#_11-类数组"><span>11. 类数组</span></a></h2>
<p>类数组并不是数组，而是长得像数组的对象。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">var</span> fakeArray <span class="token operator">=</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上述例子中的 <code v-pre>fakeArray</code> 就是一个类数组，属性是以类型数组的<code v-pre>下标</code>的形式存在，同时也具有 <code v-pre>length</code> 属性。</p>
<p>这种类数组对象，也被称为 <code v-pre>array-like对象</code> ，部分文献也称为<code v-pre>伪数组</code>。</p>
<p>类数组对象可以转化为数组，许多方法在设计时也会考虑支持类数组。</p>
<h2 id="_12-小结" tabindex="-1"><a class="header-anchor" href="#_12-小结"><span>12. 小结</span></a></h2>
<p>JavaScript 中的数组非常灵活，可以存放任意类型、任意长度 (内存足够的情况下) 的数据，其下标从 0 开始，最大到数组长度减去 1 ，并提供了一系列方法，来完成增、删、改、查操作。</p>
<p>数组项的 <code v-pre>empty</code> 和 <code v-pre>undefined</code> 的区别，是面试中常问的问题。</p>
</div></template>
